import { green, log, logError, red, registerPlugin, yellow } from '@scullyio/scully';
import { JSDOM } from 'jsdom';


export const addLinksToHeader = async (html: string, route: any) => {
  try {
    const dom = new JSDOM(html);
    const { window } = dom;
    // TODO add ability for custom selector
